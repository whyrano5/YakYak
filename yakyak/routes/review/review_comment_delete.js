...
router.get('/', function(req, res, next){
    ...
    var sql = 'DELETE FROM review_comment WHERE review_index=?';
    var sql2 = 'SELECT COUNT(*) AS count FROM review_comment WHERE review_no=?';
    var sql3 = 'UPDATE review set review_comment=? WHERE review_no=?';
