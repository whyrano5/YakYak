...
router.get('/', function(req, res, next){
    ...
    var sql = 'DELETE FROM quest_comment WHERE quest_index=?';
    var sql2 = 'SELECT COUNT(*) AS count FROM quest_comment WHERE quest_no=?';
    var sql3 = 'UPDATE quest set quest_comment=? WHERE quest_no=?';
