...
router.use('/free_comment_delete', require('./free/free_comment_delete'));
...
router.use('/question_comment_delete', require('./question/question_comment_delete'));
...
router.use('/review_comment_delete', require('./review/review_comment_delete'));
...
router.use('/New_pw', require('./login/New_pw'));
